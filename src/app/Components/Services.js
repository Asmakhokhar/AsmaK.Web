  ...
  const services = [
    {
      ...
      description:
        "Crafting responsive, pixel-perfect interfaces with React, Next.js and Tailwind CSS for exceptional user experiences.",
    ...
    },
    {
      ...
      description:
        "Building robust server-side solutions with Node.js, Express, and scalable architectures.",
    ...
    },
    {
      ...
      description:
        "Optimized database architectures with PostgreSQL, MongoDB, and efficient data modeling.",
    ...
    },
    {
      ...
      description:
        "Flawless mobile experiences with responsive design and mobile-first approaches.",
    ...
    },
    {
      ...
      description:
        "Enterprise-grade security with authentication and data protection best practices.",
    ...
    <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <SectionTitle
          ...
          description="Cutting-edge solutions that blend innovative technology with elegant design."
        />
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative h-full rounded-xl overflow-hidden">
                ...
                <div
                  className={`absolute inset-0 rounded-xl bg-gradient-to-br ${service.gradient} opacity-0 group-hover:opacity-20 transition-opacity duration-300`}
                />
